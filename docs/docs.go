    ...
    "paths": {
        ...
        "/myTest/createMyTest": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建MyTest",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/my_test.MyTest"
                        }
                    }
                ],
                "responses": {
        ...
        "/myTestOne/createMyTestOne": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建MyTestOne",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/my_test.MyTestOne"
                        }
                    }
                ],
                "responses": {
        ...
        "/myTestOne/deleteMyTestOneByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
